    ...
    try:
        ...
        if sync_engine:
            ...
            try:
                ...
                # GET EVENT COUNTS - Use cached data from last sync instead of fetching
                debug_info["event_counts"] = {
                    "note": "Event counts from last sync result",
                    "last_sync_stats": sync_engine.last_sync_result if hasattr(sync_engine, 'last_sync_result') and sync_engine.last_sync_result else {}
                }
            except Exception as e:
